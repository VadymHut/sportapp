...
const clientFilters = [<SearchInput key="q" source="q" alwaysOn placeholder="Search…" />];
...
const ConfirmDeleteBody = () => {
  ...
  return (
    <Box sx={{ pt: 0.5 }}>
      <Typography sx={{ mb: 1 }}>
        You're about to delete client <b>{rec.name} {rec.surname}</b>. You will not be able to
        restore it.
      </Typography>
      ...
      <Box sx={{ width: '100%', maxWidth: MAX_WIDTH, mx: 'auto' }}>
        <Card variant="outlined" sx={{ width: '100%' }}>
          <CardContent sx={{ pt: 2.1, pb: 0 }}>
            ...
            <Box sx={{ mb: 1 }}>
              <FilterForm filters={clientFilters} />
            </Box>
